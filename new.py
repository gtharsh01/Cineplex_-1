#database:orcl
#password:gabru harsh
#pdb:orclpdb
#oracle url:  https://localhost:5500/em
from tkinter import *
import random
import string
...
##style = Style(master) 
##master.configure("TRadiobutton", background = "white",  
##	                foreground = "black", font = ("arial", 10, "bold"))

	  
seatSelection('harry',1,Avatar).pack(side = TOP, ipady = 5)
print("harry")
receiptNum = randomString(10)

button_identities = []
def seatSelection(email, username, movie_name):
    ...
    label = Label(mainframe, bg='black', fg='white',
                  text="Screen this side", padx=5, pady=5)
    label.config(font=("Arial", 18))
    label.pack(fill="x")
    ...
    if item[i] not in filled:
        btnA1 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnA1, username, sheet))
        btnA1.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(0, weight=1)
        button_identities.append(btnA1)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=0, column=0, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(0, weight=1)
    i += 1

    if item[i] not in filled:
        btnA2 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnA2, username, sheet))
    ...
    if item[i] not in filled:
        btnA3 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnA3, username, sheet))
    ...
    if item[i] not in filled:
        ...
        btnA4 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnA4, username, sheet))
    ...
    if item[i] not in filled:
        btnA5 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnA5, username, sheet))
    ...
    if item[i] not in filled:
        ...
        btnA6 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnA6, username, sheet))
        ...
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=0, column=5, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(5, weight=1)
    ...
    if item[i] not in filled:
        ...
        btnA7 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnA7, username, sheet))
        ...
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=0, column=6, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(6, weight=1)

    i += 1

    if item[i] not in filled:
        btnA8 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnA8, username, sheet))
        ...
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=0, column=7, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(7, weight=1)

    i += 1
    if item[i] not in filled:
        btnA9 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnA9, username, sheet))
        ...
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=0, column=8, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(8, weight=1)

    i += 1

    if item[i] not in filled:
        btnA10 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                        command=lambda: onClickSeatButton(btnA10, username, sheet))
        ...
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=0, column=9, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(9, weight=1)

    i += 1

    if item[i] not in filled:
        btnB1 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnB1, username, sheet))
    ...
    if item[i] not in filled:
        ...
        btnB2 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnB2, username, sheet))
    ...
    if item[i] not in filled:
        ...
        btnB3 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnB3, username, sheet))
    ...
    if item[i] not in filled:
        ...
        btnB4 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnB4, username, sheet))
        ...
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=1, column=3, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(3, weight=1)
    ...
    if item[i] not in filled:
        ...
        btnB5 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnB5, username, sheet))
    ...
    if item[i] not in filled:
        ...
        btnB6 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnB6, username, sheet))
    ...
    if item[i] not in filled:
        ...
        btnB7 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnB7, username, sheet))
        btnB7.grid(row=1, column=6, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(6, weight=1)
        button_identities.append(btnB7)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=1, column=6, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(6, weight=1)

    i += 1
    if item[i] not in filled:
        btnB8 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnB8, username, sheet))
    ...
    if item[i] not in filled:
        btnB9 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnB9, username, sheet))
        btnB9.grid(row=1, column=8, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(8, weight=1)
        button_identities.append(btnB9)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=1, column=8, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(8, weight=1)
    i += 1
    if item[i] not in filled:
        btnB10 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                        command=lambda: onClickSeatButton(btnB10, username, sheet))
        btnB10.grid(row=1, column=9, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(9, weight=1)
        button_identities.append(btnB10)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=1, column=9, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(9, weight=1)
    i += 1
    if item[i] not in filled:
        btnC1 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnC1, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnC2 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnC2, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnC3 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnC3, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnC4 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnC4, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnC5 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnC5, username, sheet))
        btnC5.grid(row=2, column=4, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(4, weight=1)
        button_identities.append(btnC5)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=2, column=4, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(4, weight=1)
    i += 1
    if item[i] not in filled:
        btnC6 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnC6, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnC7 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnC7, username, sheet))
        btnC7.grid(row=2, column=6, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(6, weight=1)
        button_identities.append(btnC7)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=2, column=6, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(6, weight=1)
    i += 1
    if item[i] not in filled:
        btnC8 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnC8, username, sheet))
        btnC8.grid(row=2, column=7, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(7, weight=1)
        button_identities.append(btnC8)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=2, column=7, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(7, weight=1)

    i += 1
    if item[i] not in filled:
        btnC9 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnC9, username, sheet))
        btnC9.grid(row=2, column=8, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(8, weight=1)
        button_identities.append(btnC9)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=2, column=8, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(8, weight=1)
    i += 1
    if item[i] not in filled:
        btnC10 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                        command=lambda: onClickSeatButton(btnC10, username, sheet))
        btnC10.grid(row=2, column=9, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(9, weight=1)
        button_identities.append(btnC10)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=2, column=9, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(9, weight=1)
    i += 1
    if item[i] not in filled:
        btnD1 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnD1, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnD2 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnD2, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnD3 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnD3, username, sheet))
        btnD3.grid(row=3, column=2, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(2, weight=1)
        button_identities.append(btnD3)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=3, column=2, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(2, weight=1)
    i += 1
    if item[i] not in filled:
        btnD4 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnD4, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnD5 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnD5, username, sheet))
        btnD5.grid(row=3, column=4, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(4, weight=1)
        button_identities.append(btnD5)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=3, column=4, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(4, weight=1)
    i += 1
    if item[i] not in filled:
        btnD6 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnD6, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnD7 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnD7, username, sheet))
        btnD7.grid(row=3, column=6, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(6, weight=1)
        button_identities.append(btnD7)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=3, column=6, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(6, weight=1)
    i += 1
    if item[i] not in filled:
        btnD8 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnD8, username, sheet))
        btnD8.grid(row=3, column=7, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(7, weight=1)
        button_identities.append(btnD8)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=3, column=7, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(7, weight=1)
    i += 1
    if item[i] not in filled:
        btnD9 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnD9, username, sheet))
        btnD9.grid(row=3, column=8, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(8, weight=1)
        button_identities.append(btnD9)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=3, column=8, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(8, weight=1)
    i += 1
    if item[i] not in filled:
        btnD10 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                        command=lambda: onClickSeatButton(btnD10, username, sheet))
        btnD10.grid(row=3, column=9, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(9, weight=1)
        button_identities.append(btnD10)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=3, column=9, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(9, weight=1)
    i += 1
    if item[i] not in filled:
        btnE1 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnE1, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnE2 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnE2, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnE3 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnE3, username, sheet))
    ...
    i += 1
    if item[i] not in filled:
        btnE4 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnE4, username, sheet))
        btnE4.grid(row=4, column=3, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(3, weight=1)
        button_identities.append(btnE4)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=4, column=3, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(3, weight=1)
    i += 1
    if item[i] not in filled:
        btnE5 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnE5, username, sheet))
        btnE5.grid(row=4, column=4, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(4, weight=1)
        button_identities.append(btnE5)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=4, column=4, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(4, weight=1)
    i += 1
    if item[i] not in filled:
        btnE6 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnE6, username, sheet))
        btnE6.grid(row=4, column=5, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(5, weight=1)
        button_identities.append(btnE6)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=4, column=5, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(5, weight=1)
    i += 1
    if item[i] not in filled:
        btnE7 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnE7, username, sheet))
        btnE7.grid(row=4, column=6, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(6, weight=1)
        button_identities.append(btnE7)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=4, column=6, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(6, weight=1)
    i += 1
    if item[i] not in filled:
        btnE8 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnE8, username, sheet))
        btnE8.grid(row=4, column=7, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(7, weight=1)
        button_identities.append(btnE8)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=4, column=7, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(7, weight=1)
    i += 1
    if item[i] not in filled:
        btnE9 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                       command=lambda: onClickSeatButton(btnE9, username, sheet))
        btnE9.grid(row=4, column=8, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(8, weight=1)
        button_identities.append(btnE9)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=4, column=8, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(8, weight=1)
    i += 1
    if item[i] not in filled:
        btnE10 = Button(grid_frame, text=item[i], bg="gold", fg="black",
                        command=lambda: onClickSeatButton(btnE10, username, sheet))
        btnE10.grid(row=4, column=9, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(9, weight=1)
        button_identities.append(btnE10)
    else:
        lbl = Label(grid_frame, text=item[i], bg="gold", fg="black").grid(
            row=4, column=9, padx=5, pady=5, sticky="nsew")
        grid_frame.grid_columnconfigure(9, weight=1)

    Label(mainwindow, text="", width="100",
          height="2", font=("Calibri", 13)).pack()
    Label(mainwindow, text="").pack()
    Button(mainwindow, text="CONFIRM", width='30', height='2', command=lambda: onClickConfirmButton(
        mainwindow, button_identities, email, username, movie_name)).pack()
    Label(mainwindow, text="", width="100",
          height="2", font=("Calibri", 13)).pack()
    Label(mainwindow, text="").pack()
...
fetch_formDetails_sql = """SELECT * FROM user;"""
